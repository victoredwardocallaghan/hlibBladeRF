...
#ccall bladerf_sync_tx , Ptr (<bladerf>) -> Ptr () -> CUInt -> Ptr (<bladerf_metadata>) -> CUInt -> IO (CInt)
#ccall bladerf_sync_rx , Ptr (<bladerf>) -> Ptr () -> CUInt -> Ptr (<bladerf_metadata>) -> CUInt -> IO (CInt)
